			...
			return (
				<ul className="[&>li]:my-2 [&>li]:pl-0">
					<li>
						...
						to help creators build their own high quality and high performance headless
						storefronts easily.
					</li>
				</ul>
			)
			...
			return (
				<ul className="[&>li]:my-2 [&>li]:pl-0">
					...
					<li>
						...
						<strong>Electronics and Telecommunications</strong>, but I couldn't find
						interest in that field. So I learned Software Engineering instead, and

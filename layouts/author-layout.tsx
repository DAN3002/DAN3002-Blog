				...
				<div className="md:col-span-2 md:pl-12 xl:pl-16">
					<div className="prose prose-lg dark:prose-invert">
						<div>
							...
							<p>
								I'm <strong>Tuan Anh Huynh</strong> (alias <strong>Leo</strong> at
								work), a software engineer from <strong>Vietnam</strong>. I have a
								passion for all things <strong>Javascript</strong>. I enjoy building
								eCommerce software and stuff related to web dev. I work mainly with{' '}
							...
							<p>
								...
								insights and knowledge I've gained as a software engineer. Building,
								writing, and sharing things is a great way for me to solidify my
								understanding of new concepts and ideas.
							</p>
							<p>
						...
						<div>
							...
							<ul>
								...
								<li>
									<Twemoji emoji="man-technologist" /> Making a lot of changes to
									the UI, new homepage design, adding <code>ProfileCard</code>,{' '}
									<code>CareerTimeline</code> components, adding{' '}
									<code>/snippets</code>, <code>/books</code>,{' '}
